    ...
    <div class="container">
      <div class="row align-items-center justify-content-center text-center">
        ...
        <div class="col-lg-2 col-md-4 col-6 mt-2 mb-2">
          <img class="img-fluid w-50" src="<?php  echo get_theme_file_uri('image/river1.PNG')?>" alt=""> 
        </div>
        <div class="col-lg-2 col-md-4 col-6 mt-2 mb-2">
          <img class="img-fluid w-50" src="./img/client-3.png" alt="">
        </div>
        <div class="col-lg-2 col-md-4 col-6 mt-2 mb-2">
          <img class="img-fluid w-50" src="./img/client-4.png" alt="">
        </div>
        <div class="col-lg-2 col-md-4 col-6 mt-2 mb-2">
...
<h1><?php the_title();?></h1> <!-- for writting html code in php--->
    <p><?php the_content();?></p>
    <p><?php the_author();?></p>
